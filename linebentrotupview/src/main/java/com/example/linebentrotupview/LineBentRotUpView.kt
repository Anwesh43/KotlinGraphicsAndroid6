package com.example.linebentrotupview
...
fun Canvas.drawLineBentRotUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBRUNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBentRotUp(scale, w, h, paint)
}

class LineBentRotUpView(ctx : Context) : View(ctx) {
    ...
    data class LineBentRotUp(var i : Int) {
    ...
    companion object {
        fun create(activity: Activity) : LineBentRotUpView {
            val view : LineBentRotUpView = LineBentRotUpView(activity)
