package com.example.linearcjoinrightview
...
fun Canvas.drawLineArcJoinRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLAJRNode(i : Int, scale : Float, paint : Paint) {
...
class LineArcJoinRightView(ctx : Context) : View(ctx) {
    ...
    data class LineArcJoinRight(var i : Int) {

        private var curr : LAJRNode = LAJRNode(0)
    ...
    companion object {
        fun create(activity: Activity) : LineArcJoinRightView {
            val view : LineArcJoinRightView = LineArcJoinRightView(activity)
