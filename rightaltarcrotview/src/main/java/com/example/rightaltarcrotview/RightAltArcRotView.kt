package com.example.rightaltarcrotview
...
fun Canvas.drawRightAltArcRot(scale : Float, w : Float, h : Float, paint : Paint) {
    val dsc : (Int) -> Float = {
...
fun Canvas.drawRAARNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawRightAltArcRot(scale, w, h, paint)
}

class RightAltArcRotView(ctx : Context) : View(ctx) {
    ...
    data class RAARNode(var i : Int = 0, val state : State = State()) {
    ...
    data class RightAltArcRot(var i : Int = 0, val state : State = State()) {
    ...
    companion object {
        fun create(activity : Activity) : RightAltArcRotView {
            val view : RightAltArcRotView = RightAltArcRotView(activity)
