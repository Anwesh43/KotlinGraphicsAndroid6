package com.example.rottrapeziumlineview
...
fun Canvas.drawRotTrapeziumLine(scale : Float, w : Float, h : Float, paint : Paint) {
...
class RotTrapeziumLineView(ctx : Context) : View(ctx) {
    ...
    data class RTLNode(var i : Int = 0, val state : State = State()) {
    ...
    data class RotTrapeziumLine(var i : Int) {

        private var curr : RTLNode = RTLNode(0)
