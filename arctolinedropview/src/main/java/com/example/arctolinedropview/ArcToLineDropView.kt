package com.example.arctolinedropview
...
fun Canvas.drawArcToLineDrop(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawATLDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawArcToLineDrop(scale, w, h, paint)
}

class ArcToLineDropView(ctx : Context) : View(ctx) {
    ...
    data class ArcToLineDrop(var i : Int) {

        private var curr : ATLDNode = ATLDNode(0)
