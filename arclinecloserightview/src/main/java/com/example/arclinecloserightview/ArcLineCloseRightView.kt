package com.example.arclinecloserightview
...
fun Canvas.drawArcLineCloseRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawALCRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawArcLineCloseRight(scale, w, h, paint)
}

class ArcLineCloseRightView(ctx : Context) : View(ctx) {
    ...
    data class ArcLineCloseRight(var i : Int) {
