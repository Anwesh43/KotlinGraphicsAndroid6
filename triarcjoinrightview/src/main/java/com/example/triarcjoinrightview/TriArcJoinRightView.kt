package com.example.triarcjoinrightview
...
fun Canvas.drawTriArcJoinRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawTAJRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawTriArcJoinRight(scale, w, h, paint)
}

class TriArcJoinRightView(ctx : Context) : View(ctx) {
    ...
    data class TriArcJoinRight(var i : Int) {
