package com.example.diaglinearcjoinview
...
fun Canvas.drawDiagLineArcJoin(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawDLAJNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawDiagLineArcJoin(scale, w, h, paint)
}

class DiagLineArcJoinView(ctx : Context) : View(ctx) {
    ...
    data class DiagLineArcJoin(var i : Int) {
